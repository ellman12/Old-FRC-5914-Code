...
public class Robot extends TimedRobot {
  ...
  public void teleopPeriodic() {
    ...
    drive.diff_drive.arcadeDrive(-drive.stick.getRawAxis(1), drive.stick.getRawAxis(0) * .76, true);
  }
  ...
  public void gamePositionsY() {
    if (drive.stick.getRawButton(BUTTON_Y) == true && pressedYonce == false && pressedYtwice == false
        && pressedYthrice == false) {
      pressedYonce = true;
    } else if (drive.stick.getRawButton(BUTTON_Y) == true && pressedYonce == true && pressedYtwice == false
        && pressedYthr1ice == false) {
      pressedYonce = false;
      pressedYtwice = true;
    } else if (drive.stick.getRawButton(BUTTON_Y) == true && pressedYonce == false && pressedYtwice == true
        && pressedYthrice == false) {
      pressedYtwice = false;
      pressedYthrice = true;
    } else if (drive.stick.getRawButton(BUTTON_Y) == true && pressedYonce == false && pressedYtwice == false
        && pressedYthrice == true) {
      pressedYthrice = false;
      pressedYonce = true;
    }
  ...
  public void gamePositionsX() {
    if (drive.stick.getRawButton(BUTTON_X) == true && pressedXonce == false && pressedXtwice == false
        && pressedXthrice == false && pressedXquad == false) {
      pressedXonce = true;
    } else if (drive.stick.getRawButton(BUTTON_X) == true && pressedXonce == true && pressedXtwice == false
        && pressedXthrice == false && pressedXquad == false) {
      pressedXonce = false;
      pressedXtwice = true;
    } else if (drive.stick.getRawButton(BUTTON_X) == true && pressedXonce == false && pressedXtwice == true
        && pressedXthrice == false && pressedXquad == false) {
      pressedXtwice = false;
      pressedXthrice = true;
    } else if (drive.stick.getRawButton(BUTTON_X) == true && pressedXonce == false && pressedXtwice == false
